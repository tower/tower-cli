...
/// struct for passing parameters to the method [`verify_email`]
#[derive(Clone, Debug)]
...
/// struct for typed successes of method [`resend_email_verification`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ResendEmailVerificationSuccess {
    Status204(),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`verify_email`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VerifyEmailSuccess {
    Status200(models::VerifyEmailResponse),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`resend_email_verification`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
) -> Result<ResponseContent<CreateAuthenticatorSuccess>, Error<CreateAuthenticatorError>> {
...
) -> Result<ResponseContent<CreatePasswordResetSuccess>, Error<CreatePasswordResetError>> {
...
) -> Result<ResponseContent<DeleteAuthenticatorSuccess>, Error<DeleteAuthenticatorError>> {
    let uri_str = format!("{}/authenticators", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn generate_authenticator(
    configuration: &configuration::Configuration,
) -> Result<ResponseContent<GenerateAuthenticatorSuccess>, Error<GenerateAuthenticatorError>> {
    let uri_str = format!("{}/authenticators/generate", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
...
pub async fn list_authenticators(
    configuration: &configuration::Configuration,
) -> Result<ResponseContent<ListAuthenticatorsSuccess>, Error<ListAuthenticatorsError>> {
    let uri_str = format!("{}/authenticators", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn resend_email_verification(
    configuration: &configuration::Configuration,
) -> Result<ResponseContent<ResendEmailVerificationSuccess>, Error<ResendEmailVerificationError>> {
    let uri_str = format!("{}/user/resend-verification", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<ResendEmailVerificationSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            tower_trace_id,
            status,
            content,
        ...
        let content = resp.text().await?;
        let entity: Option<ResendEmailVerificationError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            tower_trace_id,
            status,
            content,
...
pub async fn update_password_reset(
    configuration: &configuration::Configuration,
    params: UpdatePasswordResetParams,
) -> Result<ResponseContent<UpdatePasswordResetSuccess>, Error<UpdatePasswordResetError>> {
    let uri_str = format!(
...
pub async fn verify_email(
...
) -> Result<ResponseContent<VerifyEmailSuccess>, Error<VerifyEmailError>> {
    let uri_str = format!("{}/user/verify", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&params.verify_email_params);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<VerifyEmailSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            tower_trace_id,
            status,
            content,
