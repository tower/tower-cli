...
pub async fn delete_catalog(configuration: &configuration::Configuration, params: DeleteCatalogParams) -> Result<ResponseContent<DeleteCatalogSuccess>, Error<DeleteCatalogError>> {
    ...
    let uri_str = format!("{}/catalogs/{name}", configuration.base_path, name=crate::apis::urlencode(params.name));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_team_invitation(configuration: &configuration::Configuration, params: DeleteTeamInvitationParams) -> Result<ResponseContent<DeleteTeamInvitationSuccess>, Error<DeleteTeamInvitationError>> {
    ...
    let uri_str = format!("{}/teams/{name}/invites", configuration.base_path, name=crate::apis::urlencode(params.name));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn describe_email_preferences(configuration: &configuration::Configuration) -> Result<ResponseContent<DescribeEmailPreferencesSuccess>, Error<DescribeEmailPreferencesError>> {
...
pub async fn generate_app_statistics(configuration: &configuration::Configuration, params: GenerateAppStatisticsParams) -> Result<ResponseContent<GenerateAppStatisticsSuccess>, Error<GenerateAppStatisticsError>> {
...
pub async fn leave_team(configuration: &configuration::Configuration, params: LeaveTeamParams) -> Result<ResponseContent<LeaveTeamSuccess>, Error<LeaveTeamError>> {
    ...
    let uri_str = format!("{}/teams/{name}/leave", configuration.base_path, name=crate::apis::urlencode(params.name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn list_environments(configuration: &configuration::Configuration) -> Result<ResponseContent<ListEnvironmentsSuccess>, Error<ListEnvironmentsError>> {
...
pub async fn list_plans(configuration: &configuration::Configuration, params: ListPlansParams) -> Result<ResponseContent<ListPlansSuccess>, Error<ListPlansError>> {
...
pub async fn list_team_members(configuration: &configuration::Configuration, params: ListTeamMembersParams) -> Result<ResponseContent<ListTeamMembersSuccess>, Error<ListTeamMembersError>> {
    ...
    let uri_str = format!("{}/teams/{name}/members", configuration.base_path, name=crate::apis::urlencode(params.name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn resend_email_verification(configuration: &configuration::Configuration) -> Result<ResponseContent<ResendEmailVerificationSuccess>, Error<ResendEmailVerificationError>> {
...
pub async fn resend_team_invitation(configuration: &configuration::Configuration, params: ResendTeamInvitationParams) -> Result<ResponseContent<ResendTeamInvitationSuccess>, Error<ResendTeamInvitationError>> {
    ...
    let uri_str = format!("{}/teams/{name}/invites/resend", configuration.base_path, name=crate::apis::urlencode(params.name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn update_account_name(configuration: &configuration::Configuration, params: UpdateAccountNameParams) -> Result<ResponseContent<UpdateAccountNameSuccess>, Error<UpdateAccountNameError>> {

    let uri_str = format!("{}/accounts/{name}", configuration.base_path, name=crate::apis::urlencode(params.name));
...
pub async fn update_email_preferences(configuration: &configuration::Configuration, params: UpdateEmailPreferencesParams) -> Result<ResponseContent<UpdateEmailPreferencesSuccess>, Error<UpdateEmailPreferencesError>> {
...
pub async fn update_environment(configuration: &configuration::Configuration, params: UpdateEnvironmentParams) -> Result<ResponseContent<UpdateEnvironmentSuccess>, Error<UpdateEnvironmentError>> {

    let uri_str = format!("{}/environments/{name}", configuration.base_path, name=crate::apis::urlencode(params.name));
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
...
pub async fn update_plan(configuration: &configuration::Configuration, params: UpdatePlanParams) -> Result<ResponseContent<UpdatePlanSuccess>, Error<UpdatePlanError>> {
...
pub async fn update_team(configuration: &configuration::Configuration, params: UpdateTeamParams) -> Result<ResponseContent<UpdateTeamSuccess>, Error<UpdateTeamError>> {
    ...
    let uri_str = format!("{}/teams/{name}", configuration.base_path, name=crate::apis::urlencode(params.name));
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
...
pub async fn verify_email(configuration: &configuration::Configuration, params: VerifyEmailParams) -> Result<ResponseContent<VerifyEmailSuccess>, Error<VerifyEmailError>> {
