...
impl Run {
    pub fn new(app_slug: String, app_version: String, cancelled_at: Option<String>, created_at: String, ended_at: Option<String>, environment: String, number: i64, run_id: String, scheduled_at: String, started_at: Option<String>, status: Status, status_group: StatusGroup) -> Run {
        Run {
            app_slug,
            app_version,
            cancelled_at,
