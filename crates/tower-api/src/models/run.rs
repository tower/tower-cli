...
pub struct Run {
    ...
    pub app_name: String,
    /// The app name presented as app_slug to support legacy CLI clients
...
impl Run {
    pub fn new(app_name: String, app_version: String, cancelled_at: Option<String>, created_at: String, ended_at: Option<String>, environment: String, exit_code: Option<i64>, number: i64, parameters: Vec<models::RunParameter>, run_id: String, scheduled_at: String, started_at: Option<String>, status: Status, status_group: StatusGroup) -> Run {
        Run {
            app_name,
            app_slug: None,
            app_version,
