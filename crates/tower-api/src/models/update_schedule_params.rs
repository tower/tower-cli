...
pub struct UpdateScheduleParams {
    ...
    /// Reassign the schedule's runtime owner. Requires team admin scope. Setting this field does NOT change the schedule's status — disabled schedules must be re-activated separately.
