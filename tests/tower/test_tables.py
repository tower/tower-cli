...
def test_upsert_to_tables(in_memory_catalog):
    ...
    data_with_schema = pa.Table.from_pylist([
        {"id": 1, "username": "alicea", "name": "Alice", "age": 30, "created_at": datetime.datetime(2023, 1, 1, 0, 0, 0)},
        {"id": 2, "username": "bobb", "name": "Bob", "age": 25, "created_at": datetime.datetime(2023, 1, 2, 0, 0, 0)},
        {"id": 3, "username": "charliec", "name": "Charlie", "age": 35, "created_at": datetime.datetime(2023, 1, 3, 0, 0, 0)},
    ], schema=schema)
    ...
    data_with_schema = pa.Table.from_pylist([
        {"id": 2, "username": "bobb", "name": "Bob", "age": 26, "created_at": datetime.datetime(2023, 1, 2, 0, 0, 0)},
    ], schema=schema)
