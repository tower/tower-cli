...
@pytest.mark.skip(reason="Not runnable right now in GH Actions")
def test_llms_nameres_with_nonexistent_model_on_hugging_face_hub(
    mock_hf_together_context,
):
...
@pytest.mark.skip(reason="Not runnable right now in GH Actions")
def test_llms_nameres_with_exact_model_name_on_hugging_face_hub(
    mock_hf_together_context,
):
