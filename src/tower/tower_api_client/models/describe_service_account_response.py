...
T = TypeVar("T", bound="DescribeServiceAccountResponse")


@_attrs_define
class DescribeServiceAccountResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        describe_service_account_response = cls(
            service_account=service_account,
            schema=schema,
        )

        return describe_service_account_response
