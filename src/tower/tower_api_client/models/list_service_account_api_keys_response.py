...
T = TypeVar("T", bound="ListServiceAccountAPIKeysResponse")


@_attrs_define
class ListServiceAccountAPIKeysResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_service_account_api_keys_response = cls(
            api_keys=api_keys,
            pages=pages,
            schema=schema,
        )

        return list_service_account_api_keys_response
