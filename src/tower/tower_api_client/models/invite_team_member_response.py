...
T = TypeVar("T", bound="InviteTeamMemberResponse")
...
class InviteTeamMemberResponse:
    ...
    Attributes:
        ...
        schema (Union[Unset, str]): A URL to the JSON Schema for this object. Example:
            http://localhost:8081/v1/schemas/InviteTeamMemberResponse.json.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invite_team_member_response = cls(
            team_invitations=team_invitations,
            schema=schema,
        )

        return invite_team_member_response
