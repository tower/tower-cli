...
) -> ErrorModel | GenerateAuthenticatorResponse:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorModel | GenerateAuthenticatorResponse]:
    return Response(
...
def sync(
    *,
    client: AuthenticatedClient,
) -> ErrorModel | GenerateAuthenticatorResponse | None:
    """Generate authenticator
