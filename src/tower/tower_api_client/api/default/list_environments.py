...
) -> ErrorModel | ListEnvironmentsResponse:
    if response.status_code == 200:
        response_200 = ListEnvironmentsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorModel | ListEnvironmentsResponse]:
    return Response(
...
def sync(
    *,
    ...
    page: int | Unset = 1,
    page_size: int | Unset = 20,
) -> ErrorModel | ListEnvironmentsResponse | None:
    """List environments
