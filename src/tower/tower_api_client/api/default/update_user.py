...
def _parse_response(*, response: httpx.Response) -> Optional[UpdateUserResponse]:
...
def _build_response(*, response: httpx.Response) -> Response[UpdateUserResponse]:
    return Response(
