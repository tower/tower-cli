...
def _parse_response(*, response: httpx.Response) -> Optional[DeleteTeamResponse]:
...
def _build_response(*, response: httpx.Response) -> Response[DeleteTeamResponse]:
    return Response(
